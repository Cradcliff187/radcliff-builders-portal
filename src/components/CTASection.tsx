...
import { trackCTAClick, trackClickToCall, trackClickToEmail } from "@/lib/analytics";
      ...
      <PageContainer className="text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12">
          ...
          <Button
            ...
            onClick={() => trackClickToCall(phoneNumber, 'cta_section_button')}
          >
        ...
        <div className="flex items-center justify-center gap-2 text-white/80">
          ...
          <a
            ...
            aria-label={`Email Radcliff Construction Group at ${emailPrimary}`}
            onClick={() => trackClickToEmail(emailPrimary, 'cta_section_link')}
          >
            {emailPrimary}
          </a>
        </div>
